# reg-simple-demo
:space_invader: [reg-suit](https://github.com/reg-viz/reg-suit) demonstration repository :space_invader:
...
:robot_face: This repository includes the following CI services' script:
